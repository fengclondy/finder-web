...
<div class="menu-bar">
    ...
    <a class="button refresh" href="javascript:void(0)"><span class="refresh">&nbsp;</span>刷新</a>
    <div class="button-wrap">
        <a class="button create" href="javascript:void(0)"><span class="add">&nbsp;</span>新建定时任务</a>
        <a class="button build"  href="javascript:void(0)"><span class="refresh">&nbsp;</span>重启全部任务</a>
    </div>
</div>
