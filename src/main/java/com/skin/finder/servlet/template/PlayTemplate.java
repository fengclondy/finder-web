 ...
 * $Date: 2017-08-05 $
 *
 * JSP generated by JspCompiler-1.0.0 (built 2017-08-05 00:43:18 555)
 */
...
public class PlayTemplate extends com.skin.finder.web.servlet.JspServlet {
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        out.write("    var path = document.body.getAttribute(\"path\");\r\n    var prefix = \"");
        this.print(out, request.getAttribute("contextPath"));
        out.write("/finder/download.html?workspace=\" + encodeURIComponent(workspace);\r\n    playList.add({\"title\": \"test\", \"url\": prefix + \"&path=\" + encodeURIComponent(path)});\r\n");
        ...
        out.write("/finder/index.html?workspace=");
        this.print(out, request.getAttribute("URLUtil.encode(workspace)"));
        out.write(" -->\r\n<!-- http://");
        this.print(out, request.getAttribute("loacalIp"));
        out.write("/finder/display.html?workspace=");
        this.print(out, request.getAttribute("URLUtil.encode(workspace)"));
        out.write("&path=");
        this.print(out, request.getAttribute("URLUtil.encode(path)"));
        out.write(" -->\r\n<body loacalIp=\"");
        this.print(out, request.getAttribute("loacalIp"));
        ...
        out.write("\" path=\"");
        this.print(out, request.getAttribute("(path != '' ? path : '/')"));
