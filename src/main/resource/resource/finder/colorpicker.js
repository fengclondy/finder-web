...
ColorDialog.getHtml = function() {
    ...
    b[b.length] = "<div style=\"clear: both; margin: 0px 1px 0px 1px; padding-left: 4px; border-top: 1px solid #333333; background-color: #ff9933; line-height: 24px; font-size: 12px; color: #ffffff; text-align: center;\">";
    b[b.length] = "<a style=\"text-decoration: none; color: #ffffff;\" href=\"javascript:void(0)\" onclick=\"ColorDialog.close();\">关&nbsp;闭</a></div>";
    return b.join("");
};
